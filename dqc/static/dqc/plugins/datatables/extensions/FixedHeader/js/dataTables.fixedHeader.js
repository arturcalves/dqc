...
FixedHeader.prototype = {
	...
	/**
	 * Copy the util_classes of all child nodes from one element to another. This implies
	 * that the two have identical structure - no error checking is performed to that
	 * fact.
	 *  @param {element} source Node to copy util_classes from
	 *  @param {element} dest Node to copy util_classes too
	 */
